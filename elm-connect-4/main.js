...
var $author$project$Main$fieldWidth = 7;
...
var $author$project$Main$emptyRow = A2(
	...
	$author$project$Main$fieldWidth,
	$elm$core$Basics$always(0));
var $author$project$Main$fieldHeight = 6;
var $author$project$Main$init = {
	q: A2(
		$elm$core$Array$initialize,
		$author$project$Main$fieldHeight,
		$elm$core$Basics$always($author$project$Main$emptyRow)),
	z: 1,
	I: 0
};
...
var $author$project$Main$getRow = F2(
	function (rowIndex, field) {
		return A2(
			...
			$author$project$Main$emptyRow,
			A2($elm$core$Array$get, rowIndex, field));
	});
var $author$project$Main$getCellValue = F2(
	function (field, coords) {
		return A2(
			...
			A2(
				$elm$core$Array$get,
				coords.e,
				A2($author$project$Main$getRow, coords.f, field)));
	});
var $author$project$Main$getLowestFreeCellAboveRow = F3(
	function (columnIndex, field, maxRow) {
		getLowestFreeCellAboveRow:
		while (true) {
			if (maxRow < 0) {
				return $elm$core$Maybe$Nothing;
			} else {
				if (!A2(
					$author$project$Main$getCellValue,
					field,
					{e: columnIndex, f: maxRow})) {
					return $elm$core$Maybe$Just(maxRow);
				} else {
					var $temp$columnIndex = columnIndex,
						$temp$field = field,
						$temp$maxRow = maxRow - 1;
					columnIndex = $temp$columnIndex;
					field = $temp$field;
					maxRow = $temp$maxRow;
					continue getLowestFreeCellAboveRow;
				}
			}
		}
	});
var $author$project$Main$getLowestFreeCell = F2(
...
var $author$project$Main$flatten = function (array) {
	return A3(
		$elm$core$Array$foldr,
...
var $author$project$Main$updateRow = F3(
	function (rowIndex, updateFunction, field) {
		return A3(
			$elm$core$Array$set,
			rowIndex,
			updateFunction(
				A2($author$project$Main$getRow, rowIndex, field)),
			field);
	});
var $author$project$Main$updateCell = F3(
	function (coords, newValue, field) {
		return A3(
			$author$project$Main$updateRow,
			coords.f,
			A2($elm$core$Array$set, coords.e, newValue),
			field);
	});
var $author$project$Main$throwToken = F3(
	function (tokenType, columnIndex, field) {
		var lowestFreeCell = A2($author$project$Main$getLowestFreeCell, columnIndex, field);
		return (!_Utils_eq(lowestFreeCell, $elm$core$Maybe$Nothing)) ? A3(
			$author$project$Main$updateCell,
			{
				e: columnIndex,
				f: A2($elm$core$Maybe$withDefault, 0, lowestFreeCell)
			},
			tokenType,
			field) : field;
	});
var $author$project$Main$getBestMove = F3(
	function (tokenType, field, depth) {
		var nextMoveScores = A3($author$project$Main$getNextMoveScores, tokenType, field, depth);
		var maxScore = A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$List$maximum(
				$elm$core$Array$toList(
					A2($elm$core$Array$map, $elm$core$Tuple$second, nextMoveScores))));
		return A2(
			$elm$core$Maybe$withDefault,
			_Utils_Tuple2(0, 0),
			A2(
				...
				A2(
					$elm$core$Array$filter,
					function (moveScore) {
						return _Utils_eq(moveScore.b, maxScore);
					},
					nextMoveScores)));
	});
var $author$project$Main$getNextMoveScore = F4(
	function (tokenType, field, depth, column) {
		var newField = A3($author$project$Main$throwToken, tokenType, column, field);
		if (_Utils_eq(
			$author$project$Main$getWinner(newField),
			tokenType) || (!depth)) {
			return A2($author$project$Main$totalScore, tokenType, newField) - A2($author$project$Main$totalScore, 3 - tokenType, newField);
		} else {
			var opponentsMove = A3($author$project$Main$getBestMove, 3 - tokenType, newField, depth - 1);
			return 0 - opponentsMove.b;
		}
	});
var $author$project$Main$getNextMoveScores = F3(
	function (tokenType, field, depth) {
		var allColumns = $elm$core$Array$fromList(
			A2($elm$core$List$range, 0, $author$project$Main$fieldWidth - 1));
		var possibleMoves = A2(
			$elm$core$Array$filter,
			function (column) {
				return !_Utils_eq(
					A2($author$project$Main$getLowestFreeCell, column, field),
					$elm$core$Maybe$Nothing);
			},
			allColumns);
		return A2(
			...
			function (column) {
				return _Utils_Tuple2(
					column,
					A4($author$project$Main$getNextMoveScore, tokenType, field, depth, column));
			},
			possibleMoves);
	});
var $author$project$Main$playMove = F2(
	function (model, column) {
		var newField = A3($author$project$Main$throwToken, model.z, column, model.q);
		return _Utils_update(
			model,
			{
				q: newField,
				z: 3 - model.z,
				I: $author$project$Main$getWinner(newField)
			});
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		var columnIndex = msg;
		if (!(!$author$project$Main$getWinner(model.q))) {
			return model;
		} else {
			var model1 = A2($author$project$Main$playMove, model, columnIndex);
...
var $author$project$Main$conditionalWinnerDisplay = function (model) {
	return (model.I === 1) ? _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('connect_4__winner connect_4__winner--red')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('🎉Winner: Red🎉')
				]))
		]) : ((model.I === 2) ? _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('connect_4__winner connect_4__winner--yellow')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('🎉Winner: Yellow🎉')
				]))
		]) : _List_Nil);
};
...
var $author$project$Main$ColumnClick = $elm$core$Basics$identity;
var $elm$core$String$concat = function (strings) {
	return A2($elm$core$String$join, '', strings);
};
var $author$project$Main$cellClass = function (cellValue) {
	return _List_fromArray(
		[
			$elm$html$Html$Attributes$class('connect_4__cell'),
			$elm$html$Html$Attributes$class(
			$elm$core$String$concat(
				_List_fromArray(
					[
						'connect_4__cell--value_',
						$elm$core$String$fromInt(cellValue)
					])))
		]);
};
...
var $author$project$Main$cellView = F2(
	function (index, cellValue) {
		return A2(
			$elm$html$Html$div,
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Main$cellClass(cellValue),
						_List_fromArray(
						[
...
var $author$project$Main$rowView = function (row) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('connect_4__row')
			]),
		$elm$core$Array$toList(
			A2(
				$elm$core$Array$indexedMap,
				F2(
					function (i, cellValue) {
						return A2($author$project$Main$cellView, i, cellValue);
					}),
				row)));
};
var $author$project$Main$gridView = function (grid) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('connect_4__grid')
			]),
		$elm$core$Array$toList(
			A2(
				$elm$core$Array$map,
				function (row) {
					return $author$project$Main$rowView(row);
				},
				grid)));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$css('css/styles.css'),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('connect_4__grid_container')
					]),
				A2(
					$elm$core$List$append,
					A2(
						$elm$core$List$append,
						$author$project$Main$conditionalWinnerDisplay(model),
						_List_fromArray(
							[
								$author$project$Main$gridView(model.q)
							])),
					$author$project$Main$conditionalWinnerDisplay(model)))
			]));
};
